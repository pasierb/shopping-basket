...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shopping_cart = __webpack_require__(5);

	var _shopping_cart2 = _interopRequireDefault(_shopping_cart);

	var _vent = __webpack_require__(7);

	var _vent2 = _interopRequireDefault(_vent);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var vent = new _vent2.default();
	var cart = new _shopping_cart2.default(vent);
	var products = [{
	    id: 1,
	    name: "Apple",
	    price: 0.25
	    ...
	    name: "Papaya",
	    price: 0.50,
	    discounts: [{ description: "three for the price of two!", thresholdItems: 3, freeItems: 1 }]
	}];

	_riot2.default.mount('product-list', { data: products, vent: vent });
	_riot2.default.mount('shopping-cart', { cart: cart });
